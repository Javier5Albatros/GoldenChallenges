...
@TraitName("challenges-daily")
public class DailyChallengesTrait extends Trait {

	public DailyChallengesTrait() {
		super("challenges-daily");
	}
	...
	public void onClickLeft(NPCRightClickEvent e) {
        if (e.getNPC() == this.getNPC()) {
        	...
        	ChallengeSettings settings = GoldenChallengesAPI.getChallengeManager().getSettings(ChallengeType.DAILY);
